    ...
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center px-4">
        ...
        <motion.div
          ...
          style={{ background: '#14248a', boxShadow: '0 20px 60px rgba(153, 143, 199, 0.4)' }}
        >
        ...
        >
          <h2 className="text-4xl font-extrabold mb-2" style={{ color: 'var(--text-primary)' }}>
            Ticket Registered! 
          </h2>
          <p className="text-lg font-semibold mb-4" style={{ color: '#14248a' }}>
            Submission ID: <span className="font-mono text-xl">{result.ticketId}</span>
          </p>
          <p className="text-base mb-6 max-w-md mx-auto leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
            Your cleanup has been verified by AI and sent to authorities for manual review. Check your email for confirmation.
            Once approved, <strong>{result.credits} Credits</strong> will be awarded.
          </p>
        </motion.div>
        ...
        {step === 1 && (
          ...
          >
            <div className="card p-8">
              ...
              {/* CLEANUP DETAILS & LIVE ESTIMATOR */}
              <div className="mb-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Form Inputs */}
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-bold mb-2 uppercase tracking-tight" style={{ color: 'var(--text-secondary)' }}>
                    ...
                    <input
                      ...
                      style={{ backgroundColor: 'var(--bg-body)', borderColor: 'var(--border-light)', color: 'var(--text-primary)' }}
                      value={weightKg}
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="group">Group (Self-Organized)</option>
                      <option value="community">Community/NGO Led</option>
                    </select>
                  </div>
                </div>
                ...
                <div className="flex flex-col">
                  <div className="p-5 rounded-2xl border-2 border-emerald-100 flex-1 flex flex-col justify-between" style={{ background: '#14248a, rgba(20, 36, 138, 0.05))', borderColor: 'var(--border-light)' }}>
                    <div>
                      <h4 className="font-bold text-sm mb-4 flex items-center justify-between" style={{ color: 'var(--text-secondary)' }}>
                      ...
                      <div className="flex items-baseline gap-2 mb-2">
                        ...
                        <span className="text-sm font-bold opacity-60">Credits</span>
                      </div>

                      {creditBreakdown && (
                        <div className="space-y-1 mt-4">
                          <div className="flex justify-between text-xs font-medium">
                            <span style={{ color: 'var(--text-secondary)' }}>Base Rate (10x)</span>
                            <span style={{ color: 'var(--text-primary)' }}>+{creditBreakdown.base}</span>
                          </div>
                          <div className="flex justify-between text-xs font-medium">
                            <span style={{ color: 'var(--text-secondary)' }}>Multiplier (Waste/Type)</span>
                            <span style={{ color: 'var(--text-primary)' }}>x{(creditBreakdown.wasteMultiplier * creditBreakdown.submissionMultiplier).toFixed(1)}</span>
                          </div>
                          <div className="flex justify-between text-xs font-medium">
                            <span style={{ color: 'var(--text-secondary)' }}>Area Criticality ({areaCriticality})</span>
                            <span className="text-orange-600 font-bold">x{creditBreakdown.criticalityMultiplier.toFixed(1)}</span>
                          </div>
                        </div>
                      )}
                    </div>

                    <div className="mt-4 pt-3 border-t text-[10px] leading-tight" style={{ borderColor: 'var(--border-light)', color: 'var(--text-tertiary)' }}>
                      <p>️ <strong>Disclaimer:</strong> This is a physics-based estimate. Final credits will be awarded after Admin review of before/after photos and GPS data.</p>
                      {zoneName && <p className="mt-1 font-bold text-emerald-700"> Zone detected: {zoneName}</p>}
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="border rounded-xl overflow-hidden" style={{ borderColor: 'var(--border-light)' }}>
                  ...
                  <div className="divide-y" style={{ borderColor: 'var(--border-light)' }}>
                    ...
                    <div className="px-6 py-4 grid grid-cols-2 gap-4">
                      ...
                      <dd className="font-semibold capitalize" style={{ color: 'var(--text-primary)' }}>{wasteType}</dd>
                    </div>

                    {/* Weight */}
                    <div className="px-6 py-4 grid grid-cols-2 gap-4">
                      <dt className="font-medium" style={{ color: 'var(--text-secondary)' }}>Claimed Weight</dt>
                      <dd className="font-semibold" style={{ color: 'var(--text-primary)' }}>{weightKg} kg</dd>
                    </div>
                    ...
                    <div className="px-6 py-4 grid grid-cols-2 gap-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/10 dark:to-emerald-900/10">
                      <dt className="font-medium text-green-700 dark:text-green-400">
                        ...
                        <span className="block text-xs font-normal mt-1 text-gray-500">
                          {submissionType} submission • {taggedUsers.length + 1} participants
                        </span>
                      </dt>
                      <dd className="flex flex-col items-end">
                        ...
                        <span className="text-[10px] text-gray-500 font-medium">Split equally among participants</span>
                      </dd>
                    </div>

                    {/* Credit Breakdown Detail */}
                    {creditBreakdown && (
                      <div className="px-6 py-2 bg-gray-50 dark:bg-gray-800/10 border-t border-b" style={{ borderColor: 'var(--border-light)' }}>
                        <div className="flex flex-wrap gap-4 py-2">
                          <div className="text-[10px]">
                            <span className="opacity-60 block">Base</span>
                            <span className="font-bold">+{creditBreakdown.base}</span>
                          </div>
                          <div className="text-[10px]">
                            <span className="opacity-60 block">Waste Multiplier</span>
                            <span className="font-bold">x{creditBreakdown.wasteMultiplier}</span>
                          </div>
                          <div className="text-[10px]">
                            <span className="opacity-60 block">Type Multiplier</span>
                            <span className="font-bold">x{creditBreakdown.submissionMultiplier}</span>
                          </div>
                          <div className="text-[10px]">
                            <span className="opacity-60 block">Criticality</span>
                            <span className="font-bold text-orange-600">x{creditBreakdown.criticalityMultiplier}</span>
                          </div>
                        </div>
                      </div>
                    )}
