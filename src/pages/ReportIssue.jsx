...
const ReportIssue = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setToast({ 
                type: 'success', 
                message: `Ticket ${ticketId} registered! Check your email for confirmation.` 
            });

            // Reset after a delay or show a success state
            setStep(3); // New success step
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Header */}
            <div className="flex flex-col md:flex-row justify-between items-center p-6 md:p-8 rounded-2xl relative overflow-hidden" style={{ background: '#14248a' }}>
            ...
            <AnimatePresence mode='wait'>
                {step === 1 ? (
                    ...
                    <motion.div
                        ...
                        className="card p-12 text-center max-w-2xl mx-auto space-y-6"
                    >
                        ...
                        <div>
                            <h2 className="text-3xl font-bold" style={{ color: 'var(--text-primary)' }}>Ticket Registered!</h2>
                            <p className="mt-2" style={{ color: 'var(--text-secondary)' }}>
                                We've received your report. A confirmation email has been sent to your registered address.
                            </p>
                        </div>
                        
                        <div className="bg-gray-50 dark:bg-gray-800/50 p-6 rounded-2xl border-2 border-dashed border-gray-200 dark:border-gray-700">
                            <p className="text-xs uppercase font-bold tracking-widest text-gray-500 mb-2">Your Ticket ID</p>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
                            <button
                                onClick={() => setStep(1)}
                                className="px-6 py-4 rounded-xl font-bold border-2 transition-all hover:bg-gray-50"
                                style={{ borderColor: 'var(--border-light)', color: 'var(--text-primary)' }}
                            >
                                Back to Home
                            </button>
                            <button
                                onClick={() => window.location.href = '/profile'} // Or link to My Tickets
                                className="px-6 py-4 rounded-xl font-bold text-white shadow-lg transition-all hover:scale-105"
